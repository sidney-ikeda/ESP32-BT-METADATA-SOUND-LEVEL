...
class BluetoothA2DPSink {
  public: 
    ...
    virtual void set_metadata_reader(void (*callBack)(uint8_t, const uint8_t*)); //https://github.com/pschatzmann/ESP32-A2DP/issues/29
  ...
  protected:
    ...
    void (*metadata_reader)(uint8_t, const uint8_t*) = NULL;
